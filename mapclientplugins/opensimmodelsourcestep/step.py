...
class OpenSimModelSourceStep(WorkflowStepMountPoint):
    '''
    ...
    def __init__(self, location):
        super(OpenSimModelSourceStep, self).__init__('OpenSim Model Source', location)
    ...
    def getPortData(self, index):
        ...
        '''
        return self._model # opensim#model
    ...
    def serialize(self, location):
        ...
        conf.setValue('file location', self._config['file location'])
        conf.endGroup()
    ...
    def deserialize(self, location):
        ...
        self._config['file location'] = conf.value('file location', '')
        conf.endGroup()
